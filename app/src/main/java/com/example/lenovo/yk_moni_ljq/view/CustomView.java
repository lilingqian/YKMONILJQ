package com.example.lenovo.yk_moni_ljq.view;
...
import com.example.lenovo.yk_moni_ljq.GramophoneActivity;
        ...
        for (int i=0;i<data.size();i++){
           ...
           imageView.setOnClickListener(new OnClickListener() {
              ...
              public void onClick(View v) {
                   Intent intent = new Intent(getContext(),GramophoneActivity.class);
